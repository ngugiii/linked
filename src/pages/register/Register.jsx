...
const Register = () => {
  ...
  return (
    <section className="relative register w-full text-white md:px-32 px-8">
      <div className="register_full w-full flex justify-center items-center h-full min-h-[90vh]">
        <img
          src={purple}
        ...
        />
        <div className="register-left w-[80%]">
          <img src={register} alt="" />
        </div>
        <div className="register-right w-full">
          <form
            action=""
            className="shadow-2xl flex flex-col form rounded-md px-14 py-8 w-[full]"
          >
            <h1 className="text-[#D434FE] mb-4 text-2xl font-extrabold">
              Register
            </h1>
            <div>
            ...
            <h1 className="my-4 font-bold text-xl">CREATE YOUR ACCOUNT</h1>
      ...
      <span className="my-3 text-[#D434FE] italic font-semibold">Please review your registration details before submitting</span>
      <div className="w-full flex mb-2 justify-start items-center">
        <label>
          <input
            type="checkbox"
            name="termsAgreed"
      ...
      <div className="w-full flex justify-start items-center">
        <button
          className="primaryColor w-full px-5 py-1 rounded"
      ...
      {isPopupOpen && (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center backdrop-filter backdrop-blur-sm bg-opacity-50 z-50">
            <div className="content w-[32rem] border-2 rounded-md p-7 border-[#D434FE]">
                <div className="header">
                    <img src={done} className="" alt="" />
                </div>
                <div className="text text-center">
                    <h1 className="text-3xl text-center font-bold">Congratulations!!!</h1>
                    <h1 className="text-3xl text-center mb-3 font-bold">You have Succesfully Registered</h1>
                    <h3>Yes it was easy and you did it</h3>
                    <h3 className="flex justify-center items-center">Check your mailbox for the next step <img src={wink} className="ml-2" alt="" /> </h3>
                </div>
                <div className="w-full flex justify-start mt-3 items-center">
              <button className="primaryColor w-full px-5 py-1 rounded" onClick={closePopup}>Back</button>
            </div>
            </div>
