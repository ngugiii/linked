...
const Header = () => {
  ...
  return (
    <section className="relative header w-full h-[100vh] text-white sm:px-24 px-4">
      <div className="header-full h-full flex md:flex-row flex-col flex-between">
        ...
        <div className="header-left h-full mt-[7rem] font-extrabold">
          ...
          <h2 className="text-[45px] flex text-left">
            Hackathon &nbsp;{" "}
            <span className="text-[#D434FE] text-left">1.0</span>
        ...
        <div className="header-right w-[80%] flex flex-col items-center">
          ...
          <div className="w-full relative">
            <img src={man} className="w-[35rem]" alt="man wearing Glasses" />
            <img src={layer} className="w-[35rem] absolute top-0 h-auto mx-auto" alt="man wearing Glasses" />
          </div>
        </div>
      </div>
    </section>
